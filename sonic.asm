...
loc_E0:
		...
		dc.b "Sonic 1 Overdrive                               " ; international name
		dc.b "Sonic 1 Overdrive                               " ; Domestic name
		if Revision=0
		dc.b "GM 00000000-04"   ; Serial/version number (Rev 0), format has 8 numbers, then 2 more
		else
		dc.b "GM 00000000-04"   ; Serial/version number (Rev non-0)
		endif
Checksum:
		if Revision=0
...
PlayLevel:
		...
		addq.b	#6,(v_emeralds).w ; Give all emeralds because fuck special stages
...
; Level select codes
; ---------------------------------------------------------------------------
LevSelCode_J: If Devmode = 1
		dc.b btnUp,0,$FF ;placeholder
		else
...
Map_WFall:	include	"_maps/Waterfalls.asm"
		...
		include	"_maps/SpinDash Dust - Dynamic Gfx Script.asm"
...
Art_Sonic:	binclude	"artunc/Sonic.bin"	; Sonic
		even
		Art_SpinDust:	binclude	"artunc/SpinDust.bin" ; Spindash dust
		even
; ---------------------------------------------------------------------------
...
Nem_Title:	binclude	"artnem/8x8 - Title.nem"	; Title screen patterns
		even
Blk256_Title:	binclude	"map256/Title.kos"
		even
...
; --------------------------------------------------------------
; WARNING!
;	DO NOT put any data from now on!
