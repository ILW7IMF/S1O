...
common.build_rom_and_handle_failure("sonic", "S1O", "", "-p=FF -z=0," .. compression .. ",Size_of_DAC_driver_guess,after", false, "https://github.com/sonicretro/s1disasm")
...
os.execute(extra_tools.convsym .. " sonic.lst S1O.bin -input as_lst -range 0 FFFFFF -exclude -filter \"z[A-Z].+\" -a")

-- Correct the ROM's header with a proper checksum and end-of-ROM value.
common.fix_header("S1O.bin")
