...
Pow_ChkS:
		...
		bne.s	Pow_ChkEnd
		move.b	#1,(v_shoes).w	; speed up the BG music
		move.w	#$4B0,(v_player+$34).w	; time limit (speed)
		move.w	#$4B0,(v_player+$32).w ; time limit (invincibility)
		move.b	#id_ShieldItem,(v_starsobj1).w ; load stars object ($3801)
		...
		move.b	#1,(v_invinc).w	; make Sonic Incinvible
...
;		jmp	(QueueSound1).l	; play continue sound